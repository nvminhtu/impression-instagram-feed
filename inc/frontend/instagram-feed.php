...
defined( 'ABSPATH' ) or die( "No script kiddies please!" );
    ...
    $count = 30; // number of images to show
                ...
                <div id="owl-demo" class="owl-carousel">
                    ...
                    foreach ($ins_media['data'] as $vm):
                        ...
                        <div class="item">
                            ...
                            <?php //#mtcode
                                echo 'Username: '.$vm['caption']['from']['username'];
                                echo 'Name: '.$vm['caption']['from']['full_name'];
                                echo 'Profile picture URL: '.$vm['caption']['from']['profile_picture'];
                                echo 'Created date: '.$vm['caption']['created_time'];
                             ?>
                            <?php if ($image_like == '1') : ?>
                                <!-- Image like count section start -->
                                <span class="instagram_like_count">
